...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s accure-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  accure-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded accure transaction") + "\n" +
              "  accure-tx [options] -create [commands]   " + _("Create hex-encoded accure transaction") + "\n" +
              "\n";
