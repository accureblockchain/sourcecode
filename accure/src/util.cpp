...
const char * const BITCOIN_CONF_FILENAME = "accure.conf";
const char * const BITCOIN_PID_FILENAME = "accure.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Accure";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Accure";
#else
    // Unix
    return pathRet / ".accure";
#endif
#endif
}
